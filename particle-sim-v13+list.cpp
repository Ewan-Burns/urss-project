...
void moveParticles(basic_linked_list<Particle>& particles, double dt, int iteration) {
    int inactiveCount = 0; // Count of inactive particles

    // Temporary list for particles that have crossed boundaries
    basic_linked_list<Particle> tempvec;
    ...
    if (inactiveCount > 0 && iteration % N == 0) {
...
int main(int argc, char** argv) {
    ...
    basic_linked_list<Particle> particles;
